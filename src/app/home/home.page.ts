...
export class HomePage {
  ...
  validateEmail() {
    const emailRegex = /^[a-zA-Z0-9._-]+@(outlook|gmail|hotmail|utcv\.edu\.mx)$/i;
    const customEmailRegex = /^[a-zA-Z0-9._-]+@utcv\.edu\.mx$/i;
  
    this.emailValid = emailRegex.test(this.email) || customEmailRegex.test(this.email);
  }
